$(function() {
    ...
    $('.field_upload').each(function() {
        $(this).find('input[type="file"]').on('change', function() {
            ...
            $(this).closest('.field_upload').addClass('show').find('.field_upload__name').text($(this).files[0].name);
            $(this).closest('.field_upload').find('.field_upload__close').on('click', function() {
                $(this).closest('.field_upload').removeClass('show').find('.field_upload__name').text('');
