    ...
    DOC.on('click', '.modal__close',
        function(e) {
            ...
            $(this).closest('.modal').fadeOut(300, function() {
                ...
                $(this).find('form').removeClass('error');
                $(this).find('form').find('.field-message').remove();
                $(this).find('form').find('.filed_checkbox').removeClass('error');
                $(this).find('form').find('.filed_checkbox').find('.field-message').remove();
                $(this).find('form').find('.filed_checkbox').find('input').prop('checked', false);
                $(this).find('form').find('.filed_checkbox').find('.check').removeClass('error');
                $(this).find('form').find('.filed_checkbox').find('.check').find('.field-message').remove();
                $(this).find('form').find('input[type="file"]').val('');
                $(this).find('form').find('input[type="file"]').prop('disabled', false);
            });
        });
