    ...
    DOC.on('click'.
        ...
        function(e) {
            ...
            $(this).closest('.modal').fadeOut(300, function() {
                ...
                $(this).closest('.modal').find('form').removeClass('error');
                $(this).closest('.modal').find('form').find('.field-message').remove();
                $(this).closest('.modal').find('form').find('.filed_checkbox').removeClass('error');
                $(this).closest('.modal').find('form').find('.filed_checkbox').find('.field-message').remove();
                $(this).closest('.modal').find('form').find('.filed_checkbox').find('input').prop('checked', false);
                $(this).closest('.modal').find('form').find('.filed_checkbox').find('.check').removeClass('error');
                $(this).closest('.modal').find('form').find('.filed_checkbox').find('.check').find('.field-message').remove();
            });
        });
